<?php
return [
	'basePath' => YIVIC_BASE_PLUGIN_PATH,
	'app'      => [
		/*
		|--------------------------------------------------------------------------
		| Application Name
		...
		*/
		...
		'name' => defined( 'APP_NAME' ) ? APP_NAME : 'Yivic Base',
		...
		*/
		...
		'asset_url' => YIVIC_BASE_PLUGIN_URL . '/assets/wp-app',
		...
		*/
		...
		'timezone' => defined( 'TIMEZONE' ) ? TIMEZONE : 'America/New_York',
...
//			Collective\Html\HtmlServiceProvider::class,
			 ...
			 * Custom Providers
			 */
			Yivic\Wp\YivicBase\App\Providers\WordPressServiceProvider::class,
			Yivic\Wp\YivicBase\App\Providers\ViewServiceProvider::class,
		],
