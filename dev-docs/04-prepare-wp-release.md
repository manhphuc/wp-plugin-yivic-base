...
```
git checkout master -- database public-assets resources src wp-app-config .editorconfig composer.json composer.lock yivic-base-bootstrap.php yivic-base-init.php yivic-base.php package* yarn* *.js
```
